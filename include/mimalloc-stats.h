...
// returns the thread stats for the current thread local heap. Memory returned is non-owned.
mi_decl_export const mi_stats_t*  mi_thread_stats(void) mi_attr_noexcept;

// returns the thread stats for the given heap.  Memory returned is non-owned.
